...
const VALID_FREQUENCIES = [
  ...
  "monthly",
  // ── Deep cleaning ────────────────────────────────────────────────────────
  "deepMonthly", // subscription, billed every 1 month
  "deepQuarterly", // subscription, billed every 3 months
  "deepOnetime", // one-time payment
  // ── Move-out ─────────────────────────────────────────────────────────────
  // uses "one-time" above — no separate entry needed
] as const;

const VALID_SERVICE_TYPES = ["maintenance", "deep", "moveout"] as const;
