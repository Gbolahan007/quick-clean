...
export function OfficeCTABar({
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-20 flex flex-wrap items-center gap-3 border-t border-gray-200 bg-white px-6 py-4 shadow-[0_-4px_24px_rgba(10,22,40,0.07)]">
        {/* Summary */}
        ...
        <div className="text-right">
          ...
          <p className="text-[22px] font-extrabold tracking-tight text-[#0a1628]">
            €{total.toLocaleString("fi-FI")}
            <span className="text-[13px] font-normal text-slate-400 ml-1">
              / mo
            </span>
          </p>
        </div>
        ...
        <button
          type="button"
          onClick={onBook}
          className="whitespace-nowrap rounded-xl bg-[#7c9885] px-7 py-3 text-[15px] font-bold text-white shadow-md shadow-[#7c9885]/40 transition-all duration-200 hover:scale-[1.02] hover:bg-[#6f8c78] active:scale-[0.98] cursor-pointer"
        >
          {t("ctaBookContract")}
        </button>
      </div>
